...
let FindAllCoursesUseCase = class FindAllCoursesUseCase {
    constructor(coursePersistencePort) {
...
exports.FindAllCoursesUseCase = FindAllCoursesUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('CoursePersistencePort')),
