...
exports.GetSavedCardsUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const logger_1 = require("@infrastructure/web/util/logger");
let GetSavedCardsUseCase = class GetSavedCardsUseCase {
    ...
    async getSavedCards(userId) {
        try {
            ...
            logger_1.logger.error(`Error in GetSavedCardsUseCase for user ${userId}:`, error);
            throw new Error(`Failed to fetch saved cards: ${error.message}`);
        }
    }
};
exports.GetSavedCardsUseCase = GetSavedCardsUseCase;
exports.GetSavedCardsUseCase = GetSavedCardsUseCase = __decorate([
