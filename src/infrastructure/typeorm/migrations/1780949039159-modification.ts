...
export class Modification1780949039159 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tests" DROP CONSTRAINT "FK_71474e6f326e11b20f17802e46b"`);
        await queryRunner.query(`ALTER TABLE "tests" DROP CONSTRAINT "UQ_71474e6f326e11b20f17802e46b"`);
        await queryRunner.query(`ALTER TABLE "tests" DROP COLUMN "lesson_id"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tests" ADD CONSTRAINT "FK_8d21344ff33d0ceef2363eb8d75" FOREIGN KEY ("module_id") REFERENCES "module"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tests" ADD "lesson_id" uuid`);
